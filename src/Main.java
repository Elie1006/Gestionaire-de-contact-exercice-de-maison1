public class Main {
    public static void main(String[] args) {
        ...
        // recherche d'un contact et affichage du numéro
        Contact contactTrouve = monGestionnaire.searchContact("Zouzou Ange Patrick");

        // Verification du contact trouvé
